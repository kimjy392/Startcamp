...
if number % 2:    # not number % 2 => 반대로 바뀜 0은 무조건 False 0, 1로 나눠지는 곳에는 이렇게 써도 됨
    print('홀수입니다.')
else:
    print('짝수입니다.')
...
# 반복 가능항 객체에 함수를 각각 적용.
int_price3 = list(map(int, prices))
print(int_price3)

int_price3 = sorted(int_price3, reverse = True) # reverse 설명에 falg가 있으면 보통 True/False 값을 가진다.
# int_price3.sort()
# int_price3.reverse()
